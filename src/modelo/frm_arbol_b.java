...
String strRecorrido = "";
    ...
    private void btnOrdenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenActionPerformed
       try{
            ...
            DefaultMutableTreeNode nodoIzquierdo = (DefaultMutableTreeNode) j_arbol.getModel().getRoot();
            txtConsola.setText(txtConsola.getText() + "Recorrido INORDEN: ");

            strRecorrido = "";
            RecorridoInorden(nodoIzquierdo);
            txtConsola.setText(txtConsola.getText() + strRecorrido.substring(0, strRecorrido.length() - 3) + "." + System.lineSeparator());
        }catch(Exception ex)
        {
    ...
    private void btnPostordenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPostordenActionPerformed
        try{
            ...
            DefaultMutableTreeNode nodoDerecha = (DefaultMutableTreeNode) j_arbol.getModel().getRoot();
            txtConsola.setText(txtConsola.getText() + "Recorrido POSORDEN: ");

            strRecorrido = "";
            RecorridoPosorden(nodoDerecha);
            txtConsola.setText(txtConsola.getText() + strRecorrido.substring(0, strRecorrido.length() - 3) + "." + System.lineSeparator());
        }catch(Exception ex)
        {
            txtConsola.setText(txtConsola.getText() + "Error en btnInordenActionPerformed(): " + ex.getMessage() + System.lineSeparator());
...
public void RecorridoInorden(DefaultMutableTreeNode nodoIzquierdo)
    {
        if(!nodoIzquierdo.getUserObject().toString().equals("I - NULL") && !nodoIzquierdo.getUserObject().toString().equals("D - NULL"))
        {
            RecorridoInorden((DefaultMutableTreeNode) nodoIzquierdo.getFirstChild());
            strRecorrido += nodoIzquierdo.getUserObject().toString().split("-")[1].trim() + " - ";
            RecorridoInorden((DefaultMutableTreeNode) nodoIzquierdo.getLastChild());
        }
    }

  public void RecorridoPosorden(DefaultMutableTreeNode nodoDerecha)
    {
        if(!nodoDerecha.getUserObject().toString().equals("I - NULL") && !nodoDerecha.getUserObject().toString().equals("D - NULL"))
        {
            RecorridoPosorden((DefaultMutableTreeNode) nodoDerecha.getFirstChild());
             RecorridoInorden((DefaultMutableTreeNode) nodoDerecha.getLastChild());
            strRecorrido += nodoDerecha.getUserObject().toString().split("-")[1].trim() + " - ";
